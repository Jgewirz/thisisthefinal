import { MapPin, Phone, Globe, Star, ExternalLink, Clock, UtensilsCrossed } from 'lucide-react';
...
export function RestaurantCard({ data, agentColor, onReserve }: RestaurantCardProps) {
  return (
    <div
