            ...
            >
              {profile.skinTone && (
                <div className="flex justify-between">
                  <span className="text-sm" style={{ color: 'var(--text-secondary)' }}>Color Season</span>
              ...
              {profile.bodyType && (
                <div className="flex justify-between">
                  <span className="text-sm" style={{ color: 'var(--text-secondary)' }}>Body Type</span>
                  <span className="text-sm font-medium" style={{ color: 'var(--text-primary)' }}>
                    {profile.bodyType}
                  </span>
                </div>
              ...
              <div className="flex justify-between">
                <span className="text-sm" style={{ color: 'var(--text-secondary)' }}>Wardrobe Items</span>
                <span className="text-sm font-medium" style={{ color: 'var(--text-primary)' }}>
