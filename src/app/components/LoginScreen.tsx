...
export function LoginScreen({ onContinueAsGuest }: LoginScreenProps) {
  return (
    ...
    >
      ...
      >
        Your AI-powered style, travel, fitness, and lifestyle assistant.
      </p>

      {/* Google Sign In Button */}
      <button
        onClick={() => loginWithGoogle()}
        className="flex items-center gap-3 px-6 py-3 rounded-xl font-medium transition-opacity hover:opacity-90 w-full max-w-xs justify-center"
        style={{
